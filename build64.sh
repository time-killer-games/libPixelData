...
if [ $(uname) = "Darwin" ]; then
  clang++ widenarrow.cpp rgbtorgba.cpp pngformat.cpp lodepng.cpp bmpformat.cpp libpixeldata.cpp /opt/local/lib/libpng.a /opt/local/lib/libz.a -I../include/ -o ../libPixelData.dylib -std=c++17 -shared -I/opt/local/include -arch arm64 -arch x86_64 -fPIC
